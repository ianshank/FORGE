...
class TestSaveCreatesFiles:
    ...
    def test_save_creates_files(self, manager, mock_agent):
...
class TestLoadLatest:
    ...
    def test_load_latest(self, manager, mock_agent):
...
class TestListCheckpoints:
    ...
    def test_list_checkpoints(self, manager, mock_agent):
...
class TestRotateCheckpoints:
    ...
    def test_rotate_checkpoints(self, tmp_path, mock_agent):
...
class TestSaveWithMetrics:
    ...
    def test_save_with_metrics(self, manager, mock_agent):
...
class TestLoadLatestEmptyDir:
    ...
    def test_load_latest_empty_dir(self, manager, mock_agent):
        result = manager.load_latest(mock_agent)
...
class TestMaxCheckpointsRespected:
    ...
    def test_max_checkpoints_respected(self, tmp_path, mock_agent):
