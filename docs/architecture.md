...
|---|---|---|
| `fmt`, `clippy`, `test`, `alloc-audit`, `coverage`, `python-lint`, `python-test`, `api-compliance`, `pip-install-clean`, `openspec-validate`, `mc-bot-test`, `forge-mc-runner-bin` | **Blocking** (CHARTER.md Invariant 6) | push / PR |
...
| `docker` | Build + push to GHCR | default branch / version tags only, `needs: [test, clippy, fmt, python-test, api-compliance, pip-install-clean, openspec-validate]` |
